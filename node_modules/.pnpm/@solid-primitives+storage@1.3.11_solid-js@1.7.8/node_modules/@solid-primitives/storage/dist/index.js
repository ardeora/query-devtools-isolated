...
function createStorageSignal(key, initialValue, props) {
  ...
  const [accessor, setter] = createHydrateSignal(
    initialValue,
    () => read() ?? initialValue,
    props
  );
...
export { addClearMethod, cookieStorage, createAsyncStorage, createCookieStorage, createLocalStorage, createSessionStorage, createStorage, createStorageSignal };
